...
public class SideDish {
    ...
    public SideDish(Long id, String name, String mass, String energyValue, BigDecimal protein, BigDecimal fats,
    ...
    public int hashCode() {
        ...
        hash = 89 * hash + Objects.hashCode(this.mass);
        hash = 89 * hash + Objects.hashCode(this.energyValue);
        hash = 89 * hash + Objects.hashCode(this.protein);
        hash = 89 * hash + Objects.hashCode(this.fats);
        hash = 89 * hash + Objects.hashCode(this.carbohydrates);
        hash = 89 * hash + Objects.hashCode(this.calcium);
        hash = 89 * hash + Objects.hashCode(this.iron);
        hash = 89 * hash + Objects.hashCode(this.vitaminA);
        hash = 89 * hash + Objects.hashCode(this.vitaminB1);
        hash = 89 * hash + Objects.hashCode(this.vitaminB2);
        hash = 89 * hash + Objects.hashCode(this.niacin);
        hash = 89 * hash + Objects.hashCode(this.vitaminC);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SideDish other = (SideDish) obj;
    ...
    public String toString() {
        return "SideDish{" + "id=" + id + ", name=" + name + ", mass=" + mass + ", energyValue=" + energyValue
                + ", protein=" + protein + ", fats=" + fats + ", carbohydrates=" + carbohydrates
                + ", calcium=" + calcium + ", iron=" + iron + ", vitaminA=" + vitaminA + ", vitaminB1=" + vitaminB1
                + ", vitaminB2=" + vitaminB2 + ", niacin=" + niacin + ", vitaminC=" + vitaminC + '}';
    }
